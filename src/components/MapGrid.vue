    ...
    <div class="container-fluid">
      <div class="row">
        <div
          class="
            col-xl-6 col-lg-12
            order-md-last order-sm-last order-last
            map-left
          "
        >
          <div class="row align-items-center mb-4">
            ...
            <div class="col-md-6 col-auto">
              <div class="view-icons">
                <a href="map-grid.html" class="grid-view active"
                  ><i class="fas fa-th-large"></i
                ></a>
                <a href="map-list.html" class="list-view"
          ...
          <div class="row">
              ...
              <div class="profile-widget">
                ...
                <div class="pro-content">
                  ...
                  <div class="row row-sm">
                    <div class="col-6">
                      <a href="profile.html" class="btn view-btn"
                        >View Profile</a
                      >
                    </div>
                    <div class="col-6">
            ...
            <div class="col-sm-6 col-md-4 col-xl-6">
              <div class="profile-widget">
                ...
                <div class="pro-content">
                  <h3 class="title">
                    <a href="profile.html">Donna Yancey</a>
                    <i class="fas fa-check-circle verified"></i>
                  </h3>
            ...
            <div class="col-sm-6 col-md-4 col-xl-6">
              <div class="profile-widget">
                ...
                <div class="pro-content">
                  <h3 class="title">
                    <a href="profile.html">Deborah Daniel</a>
                    <i class="fas fa-check-circle verified"></i>
                  </h3>
                  <p class="speciality">UNIX, Calculus, Trigonometry</p>
                  <div class="rating">
            ...
            <div class="col-sm-6 col-md-4 col-xl-6">
              <div class="profile-widget">
                ...
                <div class="pro-content">
                  <h3 class="title">
                    <a href="profile.html">Andriya Nick</a>
                    <i class="fas fa-check-circle verified"></i>
                  </h3>
                  ...
                  <ul class="available-info">
                    <li><i class="fas fa-map-marker-alt"></i> Oklahoma, USA</li>
                    <li>
                      <i class="far fa-clock"></i> Available on Fri, 22 Mar
                    </li>
                    <li>
            ...
            <div class="col-sm-6 col-md-4 col-xl-6">
              <div class="profile-widget">
                ...
                <div class="pro-content">
                  ...
                  <ul class="available-info">
                    <li><i class="fas fa-map-marker-alt"></i> Montana, USA</li>
                    <li>
                      <i class="far fa-clock"></i> Available on Fri, 22 Mar
                    </li>
                    <li>
            ...
            <div class="col-sm-6 col-md-4 col-xl-6">
              <div class="profile-widget">
                ...
                <div class="pro-content">
                  ...
                  <ul class="available-info">
                    <li><i class="fas fa-map-marker-alt"></i> Indiana, USA</li>
                    <li>
                      <i class="far fa-clock"></i> Available on Fri, 22 Mar
                    </li>
                    <li>
