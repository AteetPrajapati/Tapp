          ...
          <div class="card">
            <div class="card-body">
              ...
              >
                ...
                <a href="#" class="alert-link">problem</a> has been occurred
              ...
              >
                ...
                <a href="#" class="alert-link">message</a> has been sent
                successfully.
                <button
                  type="button"
                  class="close"
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p>
                ...
                <code>.btn-outline-*</code> class to get Rounded Outline button
              </p>
            ...
            <div class="col-12 col-md-6 col-lg-4 d-flex">
              <div class="card flex-fill">
                <div class="card-header">
                  ...
                  >
                    <li class="nav-item">
                      <a href="#tab-1" data-toggle="tab" class="nav-link active"
                        >Active</a
                      >
                    </li>
                    <li class="nav-item">
                      <a href="#tab-2" data-toggle="tab" class="nav-link"
                        >Link</a
                      >
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-12 col-md-6 col-lg-4 d-flex">
              <div class="card flex-fill">
                <div class="card-header">
                  ...
                  >
                    <li class="nav-item">
                      <a href="#tab-4" data-toggle="tab" class="nav-link active"
                        >Active</a
                      >
                    </li>
                    <li class="nav-item">
                      <a href="#tab-5" data-toggle="tab" class="nav-link"
                        >Link</a
                      >
                    </li>
                    <li class="nav-item">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <ul class="nav nav-tabs nav-tabs-top">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#top-tab3" data-toggle="tab"
                        >Messages</a
                      >
                    </li>
                  </ul>
            ...
            <div class="col-md-4 d-flex">
              <div class="card flex-fill">
                ...
                <div class="card-body">
                  ...
                  <p>
                    <a href="#" class="text-white bg-dark mb-0">White link</a>
                  </p>
                </div>
              </div>
            </div>
